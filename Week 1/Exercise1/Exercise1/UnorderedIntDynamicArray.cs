...
namespace Exercise1
{
    ...
    class UnorderedIntDynamicArray : IntDynamicArray
    {
        ...
        /// <summary>
        /// Determines the index of the last occurrence of the given item
        /// </summary>
        /// <param name="item">the item to find</param>
        /// <returns>the last index of the item or -1 if it's not found</returns>
        public override int LastIndexOf(int item)
        {
            // look for first occurrence of item in array from back to front
        ...
        /// <summary>
        /// Determines the indexes of all the occurrences of the given item
        /// </summary>
        /// <param name="item">the item to find</param>
        /// <returns>the indexes of the item or an empty list if it's not found</returns>
        public override List<int> AllIndexesOf(int item)
        {
