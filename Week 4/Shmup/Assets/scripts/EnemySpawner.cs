...
{
	// needed for spawning
	[FormerlySerializedAs("prefabTeddyBear")] [SerializeField]
    ...
    {		
        ...
        {
			// GameObject teddyBear = Instantiate(prefabEnemies) as GameObject;
			GameObject tempEnemy = EnemyPool.GetEnemies();
			tempEnemy.transform.position = worldLocation;
			tempEnemy.SetActive(true);
			// teddyBear.GetComponent<Enemy>().Move();
		}
	}
